export default function LandingWireframe() {
  const events = [
    { title: "Materials Brownbag: Emeralds", date: "Oct 22", time: "12:30–13:30", type: "Monthly", location: "DLIC • Almas Tower", price: "$ — member price shown when signed in" },
    { title: "Pitch Night: Luxury x Tech", date: "Nov 12", time: "18:30–20:30", type: "Quarterly", location: "DLIC • Auditorium", price: "$ — member price shown when signed in" },
    { title: "Women in Diamonds Gathering", date: "Dec 3", time: "17:00–19:00", type: "Quarterly", location: "DLIC • Lounge", price: "$ — member price shown when signed in" },
  ];
  ...
  return (
    <div className="min-h-screen bg-neutral-50 text-neutral-900">
      ...
      {/* Events — next 3 only, with super clear CTAs */}
      <section id="events" className="bg-white border-b border-neutral-200">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10">
          <div className="flex items-end justify-between gap-4">
            ...
            <a href="#" className="text-sm underline">View full calendar</a>
          </div>
          <div className="mt-6 grid md:grid-cols-3 gap-6">
            {events.map((e, idx) => (
              <div key={idx} className="rounded-2xl border border-dashed border-neutral-300 bg-neutral-50 p-4">
                ...
                <div className="text-sm text-neutral-500">{e.type} • {e.location}</div>
                <h3 className="mt-1 font-medium">{e.title}</h3>
                <div className="text-sm text-neutral-600">{e.date} · {e.time}</div>
                <div className="mt-3 text-sm text-neutral-600">{e.price}</div>
